...
###rpoc
# format data
asv_tab <- read.table("~/usa_nigeria/rpoc/sequence_table_rpoc.merged.txt", sep="\t", header=T, row.names=1, stringsAsFactors=F, comment.char="")
...
# plot important ASVs
pdf("./rf.geo.importance.rpoc.pdf")
...
# plot important ASVs
pdf("./rf.tooth.importance.rpoc.pdf")
varImpPlot(rf.study_group)
dev.off()

#health within location
# USA
